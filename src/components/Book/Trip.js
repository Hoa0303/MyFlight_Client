    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Lấy giá trị IdTripRoute từ cookies
                const idTripRoute = Cookies.get('IdTripRoute');

                // Tìm route dựa trên IdTripRoute từ cookies
                const route = allData.routes.find(e => e._id === idTripRoute);
